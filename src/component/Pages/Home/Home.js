    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-center align-items-center vh-20 bg-light mt-3">
                <a href="/digihubunique.apk" download>
                    <button
                        className="btn btn-primary"
                        style={{
                            backgroundColor: 'rgb(160 76 156)',
                            width: '250px',
                            height: '50px',
                            fontSize: '20px',
                            border: 'none'
            ...
            <section className="d-flex justify-content-center align-items-center pt-4 mt-4" style={{ backgroundColor: "#fff" }}>
                <p
                    ...
                    style={{
                        ...
                        backgroundColor: "#FFF",
                        color: "#000",
                        boxShadow: "0px 1px 1px 0px #313184",
                    }}
                >
                ...
                <div className="d-flex flex-row gap-3 align-items-center px-3 headingmedia">
                    ...
                    <div
                        ...
                        style={{
                            width: "98px",
                            height: "2px",
                            background: "linear-gradient(to right, #313184, #fff)",
                        }}
                    ></div>
                </div>
            </section>
                            ...
                            >
                                ...
                                <p className="mb-0 fs-5 text-secondary">
                                    ...
                                    <span>
                                        ...
                                        Games have ceaselessly been a sweetheart redirection, saturating our lives with excitement, theory, and satisfaction. Among the most respected games are Pool (reliably known as Lakadi or Ghochi) and Call Break — two stunt-taking games that request strength, a framework, and a pattern of karma. Anticipating that you should savor these games, you are in for a perfect treat! With online stages likeDigiHUb, you can now participate in both Pool and Call Break groupings for ensured cash, going toward gifted players and esteeming fast activity. In this blog, we will analyze the consistent association, rules, and frameworks behind Pool and Call Break, while featuring whyDigiHUb stays at the persuading stage for these cheering troubles.
                    ...
                    <div className='col-md-12'>
                        ...
                        <section className="py-3 d-flex justify-content-center bg-light">
                            <div className="d-flex flex-row gap-3 align-items-center px-3 headingmedia">
                                ...
                                >
                                    how to downloadDigiHUb Gaming APP
                        ...
                        <p className='text-center'>Follow the given steps below and start playing your favourite games onDigiHUb app now</p>
                    </div>
                    <div className='col-md-12'>
                        <div className="bg-white p-4 rounded-lg shadow-lg">
                            <div className="text-secondary text-left">
                                ...
                                <ul className="list-unstyled">
                                    {[
                                        "Click on 'DOWNLOAD & GET ₹30K*' button on anyDigiHUb page and wait for the app to download.",
            ...
            <div className='container-fluid ps-0'>
                <div className='row'>
                    <div className='phone-banner'>
                        <img src='./images/phonebanner.jpg' className='img-fluid' />
            ...
            <div className='container'>
                ...
                {showQr &&
                    <div className="d-flex justify-content-between font-bold  text-center align-items-center fixed relative "
                        ...
                        <h2 className="text-white downloadText text-center">Download <br />DigiHUb</h2>
                    </div>}
            </div>
        </>
    )
