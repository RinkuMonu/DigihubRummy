...
export default function Register() {
  ...
  const sendotp = async (e) => {
    e.preventDefault()
    try {
      const response = await axios.post("https://api.DigihubRummy.com/api/v1/auth/register",
        {
  ...
  const verifyotp = async (e) => {
    ...
    try {
      const response = await axios.post("https://api.DigihubRummy.com/api/v1/auth/verify-otp",
